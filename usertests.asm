...
00003ca3 <getMagic>:
SYSCALL(getMagic)
    3ca3:	b8 17 00 00 00       	mov    $0x17,%eax
    3ca8:	cd 40                	int    $0x40
    3caa:	c3                   	ret    

00003cab <incrementMagic>:
SYSCALL(incrementMagic)
    3cab:	b8 16 00 00 00       	mov    $0x16,%eax
    3cb0:	cd 40                	int    $0x40
    3cb2:	c3                   	ret    

00003cb3 <getCurrentProcessName>:
SYSCALL(getCurrentProcessName)
    3cb3:	b8 18 00 00 00       	mov    $0x18,%eax
    3cb8:	cd 40                	int    $0x40
    3cba:	c3                   	ret    

00003cbb <modifyCurrentProcessName>:
